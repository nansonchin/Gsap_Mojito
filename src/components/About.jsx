        ...
        <div className='mb-16 md:px-0 px-5'>
            <div className='content'>
                ...
                <div className='sub-content'>
                    <p className=''>Every cocktail we serve is a reflection oof out obsession with detail - from the first muddle to the fina lgarnish. That care is what turns a simple drink into something truly memorable.</p>
                    <div>
                        <p className='md:text-3xl text-xl font-bold'><span>4.5</span>/5</p>
                        <p className='text-sm'>More thatn +12000 customers</p>
                    </div>
                </div>
            </div>
        </div>
